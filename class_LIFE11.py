    ...
    def __init__(self, initial_balance = 1000.0000) -> None:
        ...
        try:
            with open(LIFE11.json_file, 'r') as file:
                ...
                # Filtrar por fecha
                df_filtered = df_time_series[df_time_series.index >= LIFE11.filter_date]
        ...
        for i in range(len(df_sorted)):
            ...
            if dividend_amount > 0:
                ...
                if only_first_time == True:
                    ...
                    print(f"Inicio(Compra Inicial LIFE11) - Balance: {balance} LIFE11={cant_life11}")
                cant +=1
                
                dividend = dividend_amount * cant_life11
                balance = balance + dividend
                dividend_life11 += dividend
                ...
                cant_life11 += int_part
                balance = decimal_part * close_value
                print(f"Recompra de {int_part} cuotas - Balance: {balance} LIFE11={cant_life11} Proventos = {dividend}")
                

        print("----------")
        print(f"FII: LIFE11 Cantidad de Meses({cant})")
        saldo_final = balance + cant_life11 * close_value 
        total_dividend = dividend_life11 
