...
class NCRA11:
    ...
    def __init__(self, initial_balance = 1000.0000) -> None:
        ...
        try:
            with open(NCRA11.json_file, 'r') as file:
                ...
                # Filtrar por fecha
                df_filtered = df_time_series[df_time_series.index >= NCRA11.filter_date]
    ...
    def history(self):
        ...
        print("----------")
        print(f"FII: NCRA11 Cantidad de Meses({cant})")
